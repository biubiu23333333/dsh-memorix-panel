...
`
    ...
    function apply(ctx) {
      ...
      // Preferred seat: the right workbench of dsh-better-sidebar.
      ...
      // Fallback seat (and no double entry when the tab exists): the shipped
      // session-header utilities, whose panel renders in the top layer.
      if (!mountedTab) {
